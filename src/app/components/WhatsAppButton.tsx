...
export function WhatsAppButton() {
  const handleWhatsAppClick = () => {
    const phoneNumber = "919991540996"; // Updated to school number
    const message = encodeURIComponent("Hi! I'd like to inquire about admissions at G.D. Convent International School.");
